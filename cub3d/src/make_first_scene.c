...
/*   Updated: 2020/04/17 00:54:54 by gmoon            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	make_first_scene(t_info *info)
{
	...
	info->scene->image = mlx_new_image(info->mlx,
										info->win_width, info->win_height);
	info->scene->image_data = (unsigned char *)mlx_get_data_addr(
							info->scene->image, &(info->scene->bpp),
